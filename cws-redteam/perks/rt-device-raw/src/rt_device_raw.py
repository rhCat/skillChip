#!/usr/bin/env python3
"""rt_device_raw — kernel red-team perk (sandbox family): mount the "device-raw" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — read raw kernel/device memory (/dev/mem) — while
...
ATTACK = "device-raw"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_device_raw", "attack": ATTACK, "family": out.family,

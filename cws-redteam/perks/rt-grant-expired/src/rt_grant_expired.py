#!/usr/bin/env python3
"""rt_grant_expired — kernel red-team perk (channel family): mount the "grant-expired" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — present an expired grant — while
...
ATTACK = "grant-expired"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_grant_expired", "attack": ATTACK, "family": out.family,

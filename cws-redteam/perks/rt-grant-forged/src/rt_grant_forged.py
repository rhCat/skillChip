#!/usr/bin/env python3
"""rt_grant_forged — kernel red-team perk (channel family): mount the "grant-forged" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — tamper a signed grant's claim — while
...
ATTACK = "grant-forged"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_grant_forged", "attack": ATTACK, "family": out.family,

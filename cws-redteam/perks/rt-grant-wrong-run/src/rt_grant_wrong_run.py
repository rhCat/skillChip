#!/usr/bin/env python3
"""rt_grant_wrong_run — kernel red-team perk (channel family): mount the "grant-wrong-run" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — reuse a grant minted for another run — while
...
ATTACK = "grant-wrong-run"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_grant_wrong_run", "attack": ATTACK, "family": out.family,

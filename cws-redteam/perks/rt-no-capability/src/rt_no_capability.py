#!/usr/bin/env python3
"""rt_no_capability — kernel red-team perk (channel family): mount the "no-capability" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — run under a grant that authorizes no capability — while
...
ATTACK = "no-capability"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_no_capability", "attack": ATTACK, "family": out.family,

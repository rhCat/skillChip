#!/usr/bin/env python3
"""rt_sysrq_reboot — kernel red-team perk (sandbox family): mount the "sysrq-reboot" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — reboot the host via /proc/sysrq-trigger — while
...
ATTACK = "sysrq-reboot"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_sysrq_reboot", "attack": ATTACK, "family": out.family,

#!/usr/bin/env python3
"""rt_write_outside — kernel red-team perk (sandbox family): mount the "write-outside" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — write outside the single writable workspace — while
...
ATTACK = "write-outside"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_write_outside", "attack": ATTACK, "family": out.family,

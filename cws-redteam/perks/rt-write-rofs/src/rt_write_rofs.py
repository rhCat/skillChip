#!/usr/bin/env python3
"""rt_write_rofs — kernel red-team perk (sandbox family): mount the "write-rofs" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — write to a read-only system path (EROFS) — while
...
ATTACK = "write-rofs"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_write_rofs", "attack": ATTACK, "family": out.family,

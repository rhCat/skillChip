#!/usr/bin/env python3
"""rt_forged_status — kernel red-team perk (channel family): mount the "forged-status" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — forge a step-result not signed by exod — while
...
ATTACK = "forged-status"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_forged_status", "attack": ATTACK, "family": out.family,

#!/usr/bin/env python3
"""rt_fs_escape — kernel red-team perk (sandbox family): mount the "fs-escape" attack THROUGH exod + the bwrap
SandboxProfile, with NO in-process software scan, and assert the SV-3 boundary REFUSED it — read a host file outside the sandbox binds — while
...
ATTACK = "fs-escape"   # BAKED: this perk pins exactly this behaviour
...
def main():
    ...
    rec = {"tool": "rt_fs_escape", "attack": ATTACK, "family": out.family,

...
# Localized layout: the script is vendored alongside this test in src/ (not in
# a sibling scripts/ dir), so resolve it from this file's own directory.
_SCRIPT_PATH = Path(__file__).resolve().parent / "fetch_api_support.py"

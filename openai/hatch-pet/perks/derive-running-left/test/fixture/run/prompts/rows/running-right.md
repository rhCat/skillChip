Create one horizontal animation strip for Codex pet `sprout`, state `running-right`.
...
Identity: same pet in every frame: A compact original Codex pet ready for animation. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
